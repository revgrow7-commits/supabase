...
**R:** Você está usando HTTP. A câmera **só funciona com HTTPS**. Use: `https://installer-track.preview.emergentagent.com`
...
1. Cole na barra de endereço:
   ```
   chrome://settings/content/siteDetails?site=https://installer-track.preview.emergentagent.com
   ```
2. Role até "Câmera"
