...
GOOGLE_REDIRECT_URI = os.environ.get('GOOGLE_REDIRECT_URI', 'https://installer-track.preview.emergentagent.com/api/auth/google/callback')
...
FRONTEND_URL = os.environ.get('FRONTEND_URL', 'https://installer-track.preview.emergentagent.com')
    ...
    try:
        ...
        if not user:
            ...
            return RedirectResponse(
                url=f"https://installer-track.preview.emergentagent.com/calendar?google_error=user_not_found"
            )
        ...
        return RedirectResponse(
            url=f"https://installer-track.preview.emergentagent.com/calendar?google_connected=true"
        )
        
    except Exception as e:
        logging.error(f"Google callback error: {str(e)}")
        return RedirectResponse(
            url=f"https://installer-track.preview.emergentagent.com/calendar?google_error=auth_failed"
        )
...
@api_router.get("/gamification/transactions/{user_id}")
...
@api_router.post("/gamification/daily-engagement")
...
@api_router.post("/gamification/process-checkout/{checkin_id}")
...
@api_router.get("/gamification/rewards")
...
@api_router.post("/gamification/rewards")
...
@api_router.delete("/gamification/rewards/{reward_id}")
...
@api_router.post("/gamification/rewards/seed")
...
@api_router.post("/gamification/redeem/{reward_id}")
...
@api_router.get("/gamification/redemptions")
...
@api_router.get("/gamification/redemptions/all")
...
@api_router.put("/gamification/redemptions/{request_id}/status")
...
@api_router.get("/gamification/report")
